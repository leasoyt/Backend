...
export class MenuCategoryService {
  ...
  @HandleError(HttpMessagesEnum.MENU_CATEGORY_CREATION_FAILED, BadRequestException)
  ...
  @HandleError(HttpMessagesEnum.MENU_CATEGORY_DELETE_FAILED, BadRequestException)
